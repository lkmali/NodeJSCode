...
export class GuestJwtAuthenticationStrategy implements AuthenticationStrategy {
  ...
  async authenticate (request: Request): Promise<UserProfile> {
    ...
    const userProfile: UserProfile = this.jwtService.verifyToken(token, ['guest', 'auth']) as UserProfile
